---
{"publish":true,"title":"The Science of Sensation","description":"Dive into the groundbreaking research of neuroscientist Dr. Norman Farb on the hidden link between sadness and sensory inhibition. Discover his finding that the true risk factor for depression isn't overthinking, but the brain's tendency to shut down sensory input in response to emotional stress. Learn about Sense Foraging, the evidence-based technique Dr. Farb proposes to counteract this shutdown, break free from \"echo chambers\" of negative thought, and forge a resilient identity by actively engaging with the rich, dynamic flow of sensation. This piece ties cutting-edge neuroscience from the 2025 Neuroscience of Meditation Summit back to the fundamental act of seeking and self-discovery.","created":"2025-10-25","modified":"2025-12-12T15:31:37.067-05:00","tags":["mindfulness","sense","psychology","NoM2025","writing"],"cssclasses":""}
---

I had the pleasure of attending the [2025 Neuroscience of Meditation Summit](https://meditation.vielight.com/?gad_source=1&gad_campaignid=22353632366&gbraid=0AAAAADgFb277XuyXyjm9ymuVmsMuyozcG&gclid=CjwKCAjwjffHBhBuEiwAKMb8pHRFsygOBFvHjhdVp0vueXUwnu0qIITVUm0-0UL-gd-X3mYW1BhwFRoC8JgQAvD_BwE) in Toronto yesterday. In the room was leading researchers, meditation practitioners, and technology innovators exploring the intersection of where science meets contemplative practice.

I've been pretty heavy on the conference circuit as of late. As I started to explicate in [[50 - Transmissions/10-Words/What do you do pt 1\|my recent piece]], the act of getting out into public spaces to exchange ideas is something I am starting to see as fundamental to identity formation (and reformation).

Yesterday the [[20 - The Human System/23 - Inner Architecture/Archetypes/Stage Manager]] decided Ali would be less of the confident entrepreneur, and more the curious seeker.
...
- **Sensory Regions Shut Down:** The brain actively works to shut down activity in sensory regions, most notably the insula, a crucial area for processing visceral signals and body feelings[^1][^2]. This is the brain's attempt to avoid the unpleasant physical sensations that accompany sadness (e.g., chest tightness, raw throat).
- **The Predictive Factor:** Crucially, the researchers found that it was not the self-reported level of sadness or high levels of "conceptual" activity (rumination) that primarily predicted poor mental health. Instead, the degree of sensory shutdown was a more powerful associate of symptoms. The greater the suppression of sensation, the higher the individual scored on measures of depression[^2].
- **Risk of Relapse:** This tendency to block out physical sensations was identified as a significant vulnerability. In a follow-up study, individuals who exhibited a higher intensity of sensory shutdown during a sad mood induction were found to be **up to 25 times more likely to relapse** into depression over a two-year period, regardless of the therapy they had received[^3].

### The Echo Chamber of Thought

Dr. Farb explains that this sensory avoidance has a disastrous consequence: it cuts off the mind from the very thing that can help update and regulate it. When we suppress the body's dynamic flow of sensation, the brain is left with only its **thoughts and established conceptual narratives** to process the experience[^3].
...
[^1]: Farb, N. A. S., Segal, Z. V., Mayberg, H., Bean, J., McKeon, D., & Anderson, A. K. (2010). Minding One's Emotions: Mindfulness Training Alters the Neural Expression of Sadness. _Emotion_, _10_(1), 25–33.

[^2]: Farb, N. A. S., & Segal, Z. V. (2024, May 13). The Senses: A Pathway to Well-being. _Mind & Life Institute_.

[^3]: University of Toronto. (2022, April 20). Feeling sensations – including ones connected to sadness – are key to depression recovery: U of T study.3

[^4]: Mindful Institute. (2024, July 20). The Four-Part Sensory Strategy to Manage Overwhelm.
